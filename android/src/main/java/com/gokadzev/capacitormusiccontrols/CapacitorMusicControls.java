...
public class CapacitorMusicControls extends Plugin {
  ...
  public void updateIsPlaying(PluginCall call) {
    ...
    try {
      ...
      if (isPlaying) setMediaPlaybackStateNew(
        PlaybackStateCompat.STATE_PLAYING
      ); else setMediaPlaybackStateNew(PlaybackStateCompat.STATE_PAUSED);
  ...
  public void updateState(PluginCall call) {
    ...
    try {
      ...
      this.notification.updateIsPlaying(isPlaying);
      if (isPlaying) this.setMediaPlaybackState(
          PlaybackStateCompat.STATE_PLAYING,
          elapsed
        ); else this.setMediaPlaybackState(
  ...
  public void registerMediaButtonEvent() {
    if (this.mediaSessionCompat != null) {
      this.mediaSessionCompat.setMediaButtonReceiver(
  ...
  private void initialize() {
    ...
    this.notification =
      new MusicControlsNotification(
        activity,
        this.notificationID,
        this.mediaSessionCompat.getSessionToken()
      );
